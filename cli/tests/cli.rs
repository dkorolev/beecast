...
/// minor bump, then the paused-state play overlay and seek-only marker/chapter jumps, then the 0.9.1 footer stamp, then the play overlay became a large monospace |>. When
...
fn generated_page_is_byte_identical_to_the_serde_era_renderer() {
  ...
  assert_eq!(got, (94736, 0xc991d20f4f106fa1, 94526, 0xa13a17dc5e09d94c), "the generated page's bytes moved");
}
