...
fn generated_page_is_byte_identical_to_the_serde_era_renderer() {
  ...
  assert_eq!(got, (112699, 0x27b8b43e49db9bd6, 112489, 0x1bd4d0cf374b5507), "the generated page's bytes moved");
}
